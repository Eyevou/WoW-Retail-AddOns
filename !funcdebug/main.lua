...
local function funcdebug_Frame_OnEvent(self, event, ...)		
	...
	if event == "GROUP_FORMED" then
		if UnitIsGroupLeader("player") then
			funcdebug_ConvertToRaidButton:Show()
		end
		funcdebug_LeavePartyX:Show()
	end
	if event == "RAID_ROSTER_UPDATE" then
		funcdebug_ConvertToRaidButton:Hide()
	end
...
function funcdebug(arg1)
	ChatFrame6:AddMessage(arg1)
end

function funcdebug_Frame_OnUpdate()
end

f:SetScript("OnEvent", funcdebug_Frame_OnEvent)
--f:SetScript("OnUpdate", funcdebug_Frame_OnUpdate)